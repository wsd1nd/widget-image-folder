# Image Folder Widget [![Circle CI](https://circleci.com/gh/Rise-Vision/widget-image-folder/tree/master.svg?style=svg)](https://circleci.com/gh/Rise-Vision/widget-image-folder/tree/master)

## Introduction

The Image Folder Widget allows you to create a playlist of images from Storage.

Image Folder Widget works in conjunction with [Rise Vision](http://www.risevision.com), the [digital signage management application](http://rva.risevision.com/) that runs on [Google Cloud](https://cloud.google.com).
...
```
git clone https://github.com/Rise-Vision/widget-image-folder.git
```
